...
return array(
    ...
    "install_enter"                  => "进入系统",
    "install_user_default"           => "系统用户：{0}/(在下面设置密码)<br/>默认用户：{1}",
    ...
    "copyright_contact"              => "授权或定制请联系QQ:<a href=\"http://wpa.qq.com/msgrd?v=3&uin=3232048103&site=qq&menu=yes\" target=\"_blank\">3232048103</a><a href=\"javascript:core.openWindow('http://kalcaddle.com/qa.html');\">问题反馈</a>",
